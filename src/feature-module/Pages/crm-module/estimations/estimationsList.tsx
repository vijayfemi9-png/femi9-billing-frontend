...
const EstimationsList = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text: any, render: any) => (
        <h2 className="d-flex align-items-center">
          ...
          <Link to={all_routes.companiesDetails} className="fs-14 fw-medium">
            {text}
          </Link>
        </h2>
      ),
    ...
    },
    {
      ...
      render: (text: any, render: any) => (
        <h2 className="d-flex align-items-center">
          <Link to="#" className="avatar rounded-circle border me-2">
            <ImageWithBasePath
              className="w-auto h-auto"
              src={`${render.img1}`}
              alt="User Image"
    ...
    },
    {
      ...
      render: (text: any, render: any) => (
        <h2 className="d-flex align-items-center">
          ...
          <Link to="#" className="d-flex flex-column fs-14 fw-medium d-flex">
            {text}
