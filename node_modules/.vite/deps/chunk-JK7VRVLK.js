...
var fullClone3 = Object.assign({}, React17);
var {
  useId
} = fullClone3;
var useEmptyId = () => "";
...
function useSyncState(defaultValue) {
  var _React$useReducer = React21.useReducer(function(x) {
    return x + 1;
  }, 0), _React$useReducer2 = _slicedToArray(_React$useReducer, 2), forceUpdate = _React$useReducer2[1];
  var currentValueRef = React21.useRef(defaultValue);
...
// node_modules/antd/es/config-provider/MotionWrapper.js
var MotionCacheContext = React28.createContext(true);
if (true) {
  MotionCacheContext.displayName = "MotionCacheContext";
}
function MotionWrapper(props) {
  const parentMotion = React28.useContext(MotionCacheContext);
  const {
    children
  } = props;
  ...
  if (needWrapMotionProviderRef.current) {
    return React28.createElement(MotionCacheContext.Provider, {
      value: motion
    }, React28.createElement(MotionProvider, {
      motion
    }, children));
  }
  return children;
...
var ProviderChildren = (props) => {
  ...
  const {
    layer
  } = React30.useContext(StyleContext_default);
...
var RefIcon = React35.forwardRef(RightOutlined);
if (true) {
...
//# sourceMappingURL=chunk-JK7VRVLK.js.map
